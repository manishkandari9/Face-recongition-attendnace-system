...
const Dashboard = () => {
  ...
  <div className="space-y-2">
    {loading ? ( // Add this condition to check if loading
      <>
        <Skeleton variant="rectangular" height={100} sx={{ bgcolor: '#3a3a3a' }} />
        <Skeleton variant="text" width="80%" height={30} sx={{ bgcolor: '#3a3a3a' }} />
        <Skeleton variant="text" width="60%" height={30} sx={{ bgcolor: '#3a3a3a' }} />
        <Skeleton variant="text" width="40%" height={30} sx={{ bgcolor: '#3a3a3a' }} />
      </>
    ) : (
      <>
  ...
  {loading ? ( // Add this condition to check if loading
    <>
     <Skeleton variant="text" width="80%" height={30} sx={{ bgcolor: '#3a3a3a' }} />
      <Skeleton variant="rectangular" height={50} sx={{ bgcolor: '#3a3a3a' }} />
      <Skeleton variant="rectangular" height={50} sx={{ bgcolor: '#3a3a3a' }} />
      <Skeleton variant="rectangular" height={50} sx={{ bgcolor: '#3a3a3a' }} />
      <Skeleton variant="text" width="60%" height={30} sx={{ bgcolor: '#3a3a3a' }} />
    </>
    ...
    <>
      <Typography variant="h6" sx={{ mb: 2, color: '#07f7ff' }}>Top Attendeese</Typography>
      {topAttendees.length > 0 ? (
        ...
        <Typography>No top attendees availablee.</Typography>              
      )}
    </>
  )}
</Paper>
